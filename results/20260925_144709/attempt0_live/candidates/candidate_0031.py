...
def sched_conv(cpu, in_dim, in_ch, out_ch, k, act=False, fence_opt=True):
...
nlb_qkv_conv = sched_conv(nlb_qkv_conv_cpu, CONV1_DIM, CONV1_FILTERS, CONV2_FILTERS, 1, fence_opt=False)
