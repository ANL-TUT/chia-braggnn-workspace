...
def sched_conv(cpu, in_dim, in_ch, out_ch, k, act=False, has_fence=True):
...
nlb_qkv_conv_nofence = sched_conv(nlb_qkv_conv_cpu, CONV1_DIM, CONV1_FILTERS, CONV2_FILTERS, 1, has_fence=False)
